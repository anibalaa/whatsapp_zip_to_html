...
Permite subir el archivo ZIP que genera WhatsApp al exportar un chat, y lo convierte en una página HTML navegable con las imágenes, audios y vídeos embebidos. Todo el procesado ocurre en el navegador del usuario, sin servidores, sin subir datos a ningún sitio.
A quién va dirigido:

Usuarios no técnicos, principalmente desde móvil Android o tablet. El lenguaje debe ser siempre claro, sin tecnicismos, con instrucciones paso a paso.
...
Abre el navegador Chrome en tu móvil o tablet y entra en [chat-zip-viewer.netlify.app](https://chat-zip-viewer.netlify.app/)
...
Abre Safari o Chrome en tu dispositivo y entra en [chat-zip-viewer.netlify.app](https://chat-zip-viewer.netlify.app/)
...
Ningún dato tuyo se sube a internet. Todo ocurre en tu propio dispositivo.
Si el chat es muy largo o tiene muchos vídeos, el archivo HTML resultante puede pesar bastante. Es normal.
